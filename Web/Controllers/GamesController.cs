...
namespace Web.Controllers
{
    public class GamesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GameId,GameName,Date,TrackId")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GameId,GameName,Date,TrackId")] Game game)
        {
            if (ModelState.IsValid)
            {
