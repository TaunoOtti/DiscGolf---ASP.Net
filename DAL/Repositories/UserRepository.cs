...
namespace DAL.Repositories
{
        ...
        IUserIntRepository
    {
        ...
        public List<UserInt> getAllUserForGame(int gameId)
        {
            throw new NotImplementedException();
        }

        public List<UserInt> GetAllUserExpectGameCreator(int userId)
        {
            return DbSet.Where(x => x.Id != userId).ToList();
        } 
    }
    ...
    public class UserRepository : UserRepository<string, Role, User, UserClaim, UserLogin, UserRole>, IUserRepository
    {
        ...
        public List<User> getAllUserForGame(int gameId)
        {
            throw new NotImplementedException();
        }
    }
