...
namespace DAL
{
    public class UOW : IUOW, IDisposable
    {
        ...
        //public IBasketRepository Baskets => GetRepo<IBasketRepository>();
        //public IGameRepository Games => GetRepo<IGameRepository>();
        //public IPlayerInGameRepository PlayerInGames => GetRepo<IPlayerInGameRepository>();
        //public ITrackRepository Tracks => GetRepo<ITrackRepository>();
        //public IScoreRepository Scores => GetRepo<IScoreRepository>();
